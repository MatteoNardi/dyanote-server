...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'api_page', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='children', null=True, to=orm['api.Page']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Page.parent'
        db.delete_column(u'api_page', 'parent_id')
    ...
    models = {
        u'api.page': {
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'children'", 'null': 'True', 'to': u"orm['api.Page']"}),
